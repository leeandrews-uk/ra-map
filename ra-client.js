...
async function fetchAllEvents({ areaId, dateFrom, dateTo, pageSize = 100, onProgress }) {
...
async function fetchAreas() {
  const data = await query(`{ areas { id name urlName } }`);
  return data.areas;
}
...
module.exports = { fetchEvents, fetchAllEvents, fetchAreas };
